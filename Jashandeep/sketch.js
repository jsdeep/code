...
var engine, world, backgroundImg, waterSound, backgroundMusic, cannonExplosion,piratel;
...
function preload() {
  ...
  piratel=loadSound("assets/pirate_laugh.mp3");
...
function showBoats() {
  if (boats.length > 0) {
    ...
    for (var i = 0; i < boats.length; i++) {
      ...
      if(!isLaughing && !piratel.isPlaying()){
        piratel.play();
        isLaughing=true;
